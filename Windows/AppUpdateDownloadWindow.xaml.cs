...
{
    public partial class AppUpdateDownloadWindow : Window
    {
        private readonly AppUpdateService _updateService;
        private readonly AppUpdateCheckResult _update;
        ...
        public AppUpdateDownloadWindow(AppUpdateService updateService, AppUpdateCheckResult update)
        {
            InitializeComponent();
            _updateService = updateService;
            _update = update;
            HeaderText.Text = $"Downloading ManifestDownloaderGUI {update.LatestTag}…";
        ...
        private async Task RunAsync()
        {
            ...
            try
            {
                DownloadedPath = await _updateService.DownloadAsync(_update, progress, _cts.Token);
                _completed = true;
